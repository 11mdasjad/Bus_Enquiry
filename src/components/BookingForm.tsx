...
${data.additionalNotes ? `📝 *Notes:* ${data.additionalNotes}` : ""}`;
  ...
  return (
    <section id="booking-form" className="relative -mt-10 sm:-mt-14 z-20 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="bg-white rounded-3xl shadow-2xl shadow-slate-900/10 border border-slate-200 p-6 sm:p-10 md:p-12 relative overflow-hidden"
        >
          {/* Top Banner Accent Line */}
          <div className="absolute top-0 left-0 right-0 h-2.5 bg-gradient-to-r from-blue-700 via-red-600 to-orange-500"></div>

          {/* Header Info with Official Logo */}
          <div className="mb-8 border-b border-slate-200 pb-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center space-x-3">
                <div className="relative w-12 h-12 shrink-0 rounded-xl overflow-hidden border border-slate-200 p-0.5 bg-white shadow-xs">
                  <Image
                ...
                <div>
                  <div className="inline-flex items-center space-x-1.5 px-3 py-0.5 rounded-full bg-red-50 text-red-700 font-extrabold text-[11px] uppercase mb-1 border border-red-100">
                    <span>MAA LAXMI TRAVELS GOPALGANJ</span>
                  </div>
                  <h2 className="text-2xl sm:text-3xl font-black text-slate-900 flex items-center gap-2">
                    <span>Passenger Ticket Inquiry Details</span>
                  </h2>
              ...
              <div className="hidden lg:flex flex-wrap items-center gap-1.5 bg-slate-50 p-2.5 rounded-2xl border border-slate-200">
                <span className="text-[11px] font-extrabold text-slate-400 uppercase px-2">
                  Routes:
                </span>
                {popularRoutes.map((route, idx) => (
                  <button
                    ...
                    className="text-xs font-bold px-3 py-1 rounded-lg bg-white border border-slate-200 text-slate-700 hover:border-red-500 hover:text-red-600 transition shadow-2xs cursor-pointer"
                  >
                    {route.from} → {route.to}
                  </button>
                ))}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 sm:space-y-8" noValidate>
                ...
                <div>
                  ...
                  <div className="relative rounded-xl shadow-2xs">
                    ...
                    <input
                      ...
                      } text-slate-900 text-sm focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition placeholder:text-slate-400`}
                    />
                  </div>
                  {errors.fullName && (
                ...
                <div>
                  ...
                  <div className="relative rounded-xl shadow-2xs">
                    ...
                    <input
                      ...
                      } text-slate-900 text-sm focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition placeholder:text-slate-400 font-mono tracking-wider`}
                    />
                  </div>
                  {errors.mobileNumber && (
                    <p className="mt-1 text-xs text-red-500 flex items-center gap-1 font-medium">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                {/* From */}
                <div>
                  <label htmlFor="pickupLocation" className="block text-sm font-semibold text-slate-700 mb-1.5">
                ...
                <div>
                  <label htmlFor="journeyDate" className="block text-sm font-semibold text-slate-700 mb-1.5">
                  ...
                  <div className="relative rounded-xl shadow-2xs">
                    ...
                    <input
                      ...
                      } text-slate-900 text-sm focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition`}
                    />
                  </div>
                  {errors.journeyDate && (
                    <p className="mt-1 text-xs text-red-500 flex items-center gap-1 font-medium">
            ...
            {/* Section 3: Clean, Properly Aligned Total Seat / Sleeper Count & Bus Preference */}
            <div className="p-5 sm:p-6 bg-slate-50/80 rounded-2xl border border-slate-200/80 space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-200 pb-3">
                ...
                <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-blue-100 text-blue-800 text-xs font-bold">
                  <span>Total Selected: {totalSeatsSelected} Seat(s)</span>
                  <span className="text-blue-400">•</span>
                  <span>
                    ({seaterDisplay} Seater 💺, {sleeperDisplay} Sleeper 🛌)
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs flex items-center justify-between gap-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <span className="text-sm font-bold text-slate-800 block">Total Seat (Seater 💺)</span>
                      <span className="text-xs text-slate-500">Pushback Seating</span>
                    </div>
                  </div>
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs flex items-center justify-between gap-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <span className="text-sm font-bold text-slate-800 block">Total Sleeper (Berths 🛌)</span>
                      <span className="text-xs text-slate-500">Upper & Lower Berths</span>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <button
                      ...
                      className={`flex items-center justify-center space-x-2 py-3 px-3 rounded-xl border font-bold transition cursor-pointer ${
                    ...
                    >
                      ...
                      <span className="text-xs sm:text-sm">Volvo AC</span>
                    </button>
                    ...
                    >
                      ...
                      <span className="text-xs sm:text-sm">Non-AC</span>
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    {(["Male", "Female", "Other"] as const).map((gVal) => (
                      <label
                        key={gVal}
                        className={`flex-1 flex items-center justify-center py-3 px-3 rounded-xl border cursor-pointer text-xs sm:text-sm font-bold transition ${
                          selectedGender === gVal
            ...
            {/* Section 4: Address & Special Instructions */}
            <div>
              <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4 flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Pickup Address */}
                <div>
                  <label htmlFor="pickupAddress" className="block text-sm font-semibold text-slate-700 mb-1.5">
                  ...
                  <div className="relative rounded-xl shadow-2xs">
                    ...
                    <textarea
                      ...
                      } text-slate-900 text-sm focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition placeholder:text-slate-400 resize-none`}
                    ></textarea>
                  </div>
                ...
                {/* Additional Notes */}
                <div>
                  <label htmlFor="additionalNotes" className="block text-sm font-semibold text-slate-700 mb-1.5">
                  ...
                  <div className="relative rounded-xl shadow-2xs">
                    ...
                    <textarea
                      ...
                      className="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-300 text-slate-900 text-sm focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition placeholder:text-slate-400 resize-none"
                    ></textarea>
                  </div>
                </div>
              </div>
            ...
            <div className="pt-4 border-t border-slate-200 text-center">
              <button
                ...
                className="w-full sm:w-auto min-w-[340px] bg-gradient-to-r from-emerald-600 via-emerald-700 to-teal-700 hover:from-emerald-700 hover:to-teal-800 text-white font-black text-lg py-4 px-10 rounded-2xl shadow-xl shadow-emerald-600/30 hover:shadow-emerald-600/40 transition transform active:scale-98 flex items-center justify-center space-x-3 mx-auto disabled:opacity-75 disabled:cursor-not-allowed group cursor-pointer"
              >
                {isSubmitting ? (
                  <>
                  ...
                  <>
                    ...
                    <span>Send Inquiry to WhatsApp (7488202225)</span>
                  </>
                )}
              </button>

              <div className="mt-4 flex items-center justify-center space-x-4 text-xs text-slate-500 font-semibold">
