  ...
  const features = [
    {
      ...
      title: "AC Luxury Fleet",
      description:
        "Premium AC luxury buses connecting Gopalganj directly to Delhi, Lucknow, Kanpur, and major routes with maximum riding comfort.",
      highlights: ["AC Luxury Coaches", "Cleaned & Sanitized", "Smooth Express Highway Travel"],
    },
    {
      icon: Armchair,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-base sm:text-lg text-slate-600 leading-relaxed font-normal">
            Providing trusted, comfortable, and safe AC bus travel services between Gopalganj, Bihar, and major North Indian destinations.
          </p>
        </div>
